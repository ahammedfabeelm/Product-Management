...
import { IProduct, Product } from 'app/shared/model/productReview/product.model';
...
export class ProductUpdateComponent implements OnInit {
  ...
  private createFromForm(): IProduct {
    return {
      ...
      averageReviewScore: this.editForm.get(['averageReviewScore'])!.value,
      numberOfReview: this.editForm.get(['numberOfReview'])!.value,
    };
  }
